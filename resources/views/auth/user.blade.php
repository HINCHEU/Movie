            ...
            <div class="row">
                ...
                <div class="col-12">
                    <div class="section__carousel-wrap">
                        ...
                        <button class="section__nav section__nav--cards section__nav--prev" data-nav="#classic"
                        ...
                        <button class="section__nav section__nav--cards section__nav--next" data-nav="#classic"
                            type="button"><svg width="17" height="15" viewBox="0 0 17 15"
                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M15.75 7.72559L0.75 7.72559" stroke-width="1.5" stroke-linecap="round"
                                    stroke-linejoin="round" />
            ...
            <div class="row">
                ...
                <div class="col-12">
                    <div class="section__carousel-wrap">
                        ...
                        <button class="section__nav section__nav--cards section__nav--prev" data-nav="#binge"
                            type="button"><svg width="17" height="15" viewBox="0 0 17 15"
                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M1.25 7.72559L16.25 7.72559" stroke-width="1.5" stroke-linecap="round"
                                    stroke-linejoin="round" />
                        ...
                        <button class="section__nav section__nav--cards section__nav--next" data-nav="#binge"
                            type="button"><svg width="17" height="15" viewBox="0 0 17 15"
                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M15.75 7.72559L0.75 7.72559" stroke-width="1.5" stroke-linecap="round"
                                    stroke-linejoin="round" />
                    ...
                    <div class="section__carousel-wrap">
                        <div class="section__carousel owl-carousel" id="subscriptions">
                            <div class="card">
                                ...
                                <h3 class="card__title card__title--subs"><a href="details.html">Sports
                                        broadcasts</a></h3>
                            ...
                            <div class="card">
                                ...
                                <h3 class="card__title card__title--subs"><a href="details.html">Films about
                                        space</a></h3>
                                <ul class="card__list card__list--subs">
        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    ...
                    <p class="section__text section__text--center">No hidden fees, equipment rentals, or installation
                        appointments.</p>
                </div>
            </div>
                        ...
                        <div class="table-responsive">
                            <table class="plans__table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <span class="plans__title">Get unlimited access to the largest streaming
                                                library with no ads</span>
                                        </td>
                                        <td>
                                            <span class="plans__status plans__status--green">
                                                <svg width="19" height="14" viewBox="0 0 19 14"
                                    ...
                                    <tr>
                                        <td>
                                            <span class="plans__title">Watch Live TV online and on supported
                                                devices</span>
                                        </td>
                                        <td>
                                            <span class="plans__status plans__status--green">
